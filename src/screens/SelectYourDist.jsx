...
//   const HaryanaCity = ['Faridabad', 'Gurgaon', 'Manesar'];
//   const KarnatakaCity = ['Bangalore'];
//   const MaharashtraCity = ['Mumbai', 'Navi Mumbai', 'Pune', 'Thane'];
//   const TelanganaCity = ['Hyderabad'];
//   const Uttar_Pradesh = ['Ghaziabad', 'Greater Noida', 'Noida'];
