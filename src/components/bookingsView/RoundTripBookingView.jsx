...
// import {AppColors} from '../../assets/Colors';
// import Modal from 'react-native-modal';
// import RoundTripAcceptModal from '../modal/RoundTripAceeptModal';

// const AddressItem = ({address, isOrigin}) => (
...
//       <View style={styles.header}>
//         <Text style={styles.time}>
//           {trip.time} <Text style={styles.date}>{trip.date}</Text>
//         </Text>
...
//           <Text style={styles.title}>{trip.title}</Text>
//           {trip.addresses.map((address, index) => (
//             <AddressItem key={index} address={address} isOrigin={index === 0} />
//           ))}
//         </View>
//         <View style={styles.rightContent}>
//           <View style={styles.paymentDetails}>
...
//             <RoundTripAcceptModal setOpenModal={setIsModalOpen} />
//           </Modal>
//         </View>
//       </View>
//     </View>
