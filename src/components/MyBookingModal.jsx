...
//   const totalAmount = extractTotal(myBookingData.total);
...
//             <Text
//               style={[styles.tabText, !myBookingStyle && styles.activeTabText]}>
//               {myBookingData.due_txt} {totalAmount}
//             </Text>
//           </View>
//         </TouchableOpacity>
//       </View>
...
const MyBookingModal = ({}) => {
  ...
  //     .then(e => {
  //       console.log(e, 'MY Bookings Data');
  //     })
  //     .catch(err => {
  //       console.log(err, 'My Booking Data Error');
  //     });
  // }, []);
