...
//     const unsubscribe = messaging().onMessage(async remoteMessage => {
//       const fbId = remoteMessage.messageId;
//       // setMessageId(fbId);
//       // await updateNotificationStatus('received', fbId);
//       const soundName = remoteMessage.notification?.android?.sound || 'sound';

//       console.log(soundName,"soundNamesoundNamesoundName");

//       try {
//         const channelId = await notifee.createChannel({
//           id: `dynamic-channel-${soundName}`,
//           name: `Dynamic Channel ${soundName}`,
//           sound: soundName,
//           importance: AndroidImportance.HIGH,
//         });
//         await notifee.displayNotification({
...
//         setError(error);
//       }
//       // await updateNotificationStatus('displayed', fbId);
//     });
//     // messaging().onNotificationOpenedApp(async remoteMessage => {
//     //   // await updateNotificationStatus('clicked', remoteMessage.messageId);
//     // });
//     // messaging()
...
//     return unsubscribe;
//   };
//   // const updateNotificationStatus = async (status, firebaseMessageId) => {
//   //   try {
...
//   //       `${BaseURL}login/update-firebase-notification-status.php`,
//   //       config,
//   //     );
