...
const ClearMyDuePaymentOvertimeModal = ({
  setMyDuePaymentModal,
  tripDetails,
}) => {
    ...
    <ScrollView>
      <View style={styles.modalContainer}>
        ...
        <View style={styles.contentContainer}>
          ...
          {typeof tripDetails?.trip_type === 'string' && (
          ...
          <View style={styles.bulletPointContainer}>
            <BulletPoint text={tripDetails?.extraday_charges_line} />
            <BulletPoint text={tripDetails?.overtime_charges_line} />
            <BulletPoint text={tripDetails?.night_charges_line} />
            <BulletPoint text={tripDetails?.package_without_gst} />
...
export default ClearMyDuePaymentOvertimeModal;
