...
// //         <Text style={styles.dueText}>Due ₹307</Text>
...
// //         <Text style={styles.bookingText}>432791 - 08 Jul, 17:45 PM</Text>
// //         <Text style={styles.arrowText}>&gt;</Text>
// //       </TouchableOpacity>

// //       <TouchableOpacity style={[styles.bookingItem, styles.activeBooking]}>
// //         <Text style={[styles.bookingText, styles.activeBookingText]}>430664 - 26 Jun, 10:30 AM</Text>
// //         <Text style={[styles.arrowText, styles.activeArrowText]}>&gt;</Text>
// //       </TouchableOpacity>
// //     </View>
// //   );
// // };
...
// const BookingsComponent = ({}) => {
//   const [myBooking, setMyBooking] = useState(true);
...
//             <Text style={[styles.tabText, myBooking && styles.activeTabText]}>
//               My Booking
//             </Text>
//           </View>
//         </TouchableOpacity>
//         <TouchableOpacity onPress={() => setMyBooking(false)}>
//           <View style={[styles.tabItem, !myBooking && styles.activeTab]}>
//             <Text style={[styles.tabText, !myBooking && styles.activeTabText]}>
//               My Due{' '}
//               <Icon name="rupee" color={myBooking ? AppColors.black : AppColors.mainColor} /> 0
//             </Text>
//           </View>
//         </TouchableOpacity>
//       </View>
...
//         <View style={{margin: 10, borderBottomWidth: 2}}>
//           <Text style={{color: 'black', paddingBottom: 3}}>My Booking</Text>
//         </View>
//         </TouchableOpacity>
//         <TouchableOpacity  onPress={()=>setMyBooking(false)} >

//         <View style={{marginHorizontal: 10, borderBottomWidth: 2}}>
//           <Text style={{color: 'black', paddingBottom: 3}}>
//             My Due <Icon name="rupee" color="black" /> 0
//           </Text>
//         </View>
//         </TouchableOpacity>
//       </View>
...
// //           alignSelf: 'flex-end',
// //         }}>
// //         <Text style={{padding: 5, paddingHorizontal: 10}}>x</Text>
// //       </View>
// // <View
// //   style={{
// //     flexDirection: 'row',
...
// //   </View>
// //   <View style={{marginHorizontal: 10, borderBottomWidth: 2}}>
// //     <Text style={{color: 'black', paddingBottom: 3}}>My Due</Text>
// //   </View>
// // </View>
...
// // const MyBookingModal = ({setMyBookingModal, visible, onClose }) => {
// //   const dueAmount = 307;
// //   const bookings = [
// //     { id: '432791', date: '08 Jul, 17:45 PM' },
// //     { id: '430664', date: '26 Jun, 10:30 AM' },
// //   ];
...
// //           <TouchableOpacity onPress={setMyBookingModal(false)} style={styles.closeButton}>
// //             <Text style={styles.closeButtonText}>X</Text>
// //           </TouchableOpacity>
// //           {/* <Text style={styles.modalTitle}>My Bookings</Text>
// //           <Text style={styles.dueAmount}>Due ₹{dueAmount}</Text> */}
// //           {/* {bookings.map((booking, index) => (
// //             <TouchableOpacity key={index}  style={styles.bookingItem}>
// //               <Text style={styles.bookingText}>{booking.id} - {booking.date}</Text>
// //             </TouchableOpacity>
// //           ))} */}
// //         </View>
// //       </View>
