...
const SelectYourCityPartnerInterface = ({route, navigation}) => {
  ...
  useEffect(() => {
    if (state == 'Delhi') {
      ...
      setCities(['Faridabad', 'Gurgaon', 'Manesar']);
    } else if (state == 'Karnataka') {
      setCities(['Banglore']);
    } else if (state == 'Maharashtra') {
      setCities(['Mumbai', 'Navi Mumbai', 'Pune', 'Thane']);
...
export default SelectYourCityPartnerInterface;
