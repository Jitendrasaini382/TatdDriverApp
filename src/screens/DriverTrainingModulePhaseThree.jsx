...
const DriverTrainingModulePhaseThree = ({navigation}) => {
  ...
  const submitAllModuleData = async () => {
    try {
      const response = await SUBMIT_ALL_TRAINING_MODULE_DATA({
        action: 'driver-training-module',
        phase: 'Booking Awareness',
      });
        ...
        <Modal visible={isVisible} transparent animationType="slide">
          <View style={styles.modalOverlay}>
            <View style={styles.modalContainer}>
              <Text style={styles.title}>🎉 Training Step 2 Completed!</Text>
...
export default DriverTrainingModulePhaseThree;
