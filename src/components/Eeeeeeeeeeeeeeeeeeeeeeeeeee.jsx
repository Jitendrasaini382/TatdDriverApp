...
const AddDriverComponent = () => {
  ...
  const openWhatsApp = () => {
    let url =
      "whatsapp://send?text=Hi! I'm inviting you to use this referral link - https://tatd.in/driver-interface.php?referrer=ODExODgxMzE0OA%3D%3D"; // You can customize the text or add a phone number like: 'whatsapp://send?phone=+123456789&text=Hello'
